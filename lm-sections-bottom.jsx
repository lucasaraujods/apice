...
const SERVICE_BLOCKS = () => [
  ...
  },
  {
    ...
    items: [
      tx('Treino sem acompanhamento presencial', 'Training without in-person supervision'),
      tx('Dieta', 'Diet plan'),
      tx('Anamnese completa', 'Full anamnesis'),
      tx('Dashboard de evolução', 'Progress dashboard'),
      tx('Materiais de apoio', 'Support materials'),
    ],
  },
  {
    id: 'apice',
...
const FAQSection = ({ openIdx, setOpenIdx }) => {
  const FAQ_ITEMS = [
  { q: tx('Preciso ir até Brasília para ser atendido?',
    'Do I have to travel to Brasília to be coached?'),
    a: tx('Só nas modalidades presenciais (Personal Premium, Avaliação Premium e Massoterapia). A Consultoria Online atende Brasil inteiro e fora do país. A Semipresencial pede deslocamento a cada 2 meses.',
    'Only for in-person formats (Personal Premium, Premium Assessment and Massage Therapy). Online Consulting serves all of Brazil and abroad. Hybrid requires travel every 2 months.') },
  { q: tx('Em quanto tempo começo a ver resultado?',
    'How long until I start seeing results?'),
    a: tx('Indicadores objetivos (força, performance, composição corporal) começam a mexer entre 4 e 8 semanas com execução consistente. Mudança estética visível geralmente entre 8 e 12 semanas. Mas o ponto é: você terá clareza do progresso desde a primeira reavaliação.',
    'Objective metrics (strength, performance, body composition) start to shift between 4 and 8 weeks with consistent execution. Visible aesthetic change usually between 8 and 12 weeks. But the point is: you will have clarity about progress from the very first re-assessment.') },
  { q: tx('E se eu nunca treinei na vida?',
    "What if I've never trained in my life?"),
    a: tx('Melhor ainda. Sem vícios para desconstruir. O método funciona do iniciante absoluto ao atleta amador avançado, a periodização respeita cada ponto de partida.',
    'Even better. No bad habits to undo. The method works from the absolute beginner to the advanced amateur athlete — periodization respects every starting point.') },
  { q: tx('A massoterapia substitui fisioterapia?',
    'Does massage therapy replace physical therapy?'),
    a: tx('Não. São coisas diferentes. Massoterapia atua em recuperação, performance e prevenção. Se identifico necessidade de fisioterapia clínica, te encaminho ao profissional certo. Honestidade técnica é regra.',
    'No. They are different things. Massage therapy targets recovery, performance and prevention. If I identify the need for clinical physical therapy, I refer you to the right professional. Technical honesty is the rule.') },
  { q: tx('Tenho restrição médica ou dor crônica. Posso entrar?',
    'I have medical restrictions or chronic pain. Can I join?'),
    a: tx('Quase sempre sim, mas com avaliação prévia. Liberação médica pode ser solicitada em alguns casos, e o treino é ajustado integralmente à sua condição.',
    'Almost always yes, but with a prior assessment. Medical clearance may be required in some cases, and the training is fully adjusted to your condition.') },
  { q: tx('Como faço para começar?',
    'How do I get started?'),
    a: tx('Clica em qualquer botão da página "quero ter acesso a consultoria", entederemos o seu objetivo e depois conversamos para entender o seu objetivo e veremos o melhor plano para você fazer parte da comunidade da Ápice.',
    'Click any button on the page and you land directly in my WhatsApp. We chat, I understand your goal, I present the plan and the investment. No commitment, no pushy selling.') }];
